        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
            <div className="text-3xl font-bold text-blue-500">
              {Math.round(
                (completedPages.length /
                  (completedPages.length + todoPages.length)) *
                  100
              )}
              %
            </div>
              ...
              <div>
                ...
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-red-600 mb-4 flex items-center gap-2">
                    ...
                    High Priority (
                    {todoPages.filter((p) => p.priority === "high").length})
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {todoPages
                ...
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-yellow-600 mb-4 flex items-center gap-2">
                    <Circle className="w-5 h-5" />
                    Medium Priority (
                    {todoPages.filter((p) => p.priority === "medium").length})
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {todoPages
                      ...
                      .map((page, index) => (
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div>
                              <div className="font-mono text-sm text-yellow-600 mb-1">
                                {page.path}
                              </div>
                              <div className="font-semibold text-gray-800">
                                {page.name}
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-600 mb-4 flex items-center gap-2">
                    <Circle className="w-5 h-5" />
                    Low Priority (
                    {todoPages.filter((p) => p.priority === "low").length})
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {todoPages
              ...
              <div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="relative pl-8 border-l-4 border-green-500">
                    ...
                    <p className="text-gray-600 mb-3">
                      Basic structure and product browsing
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm">
                        <Check className="w-4 h-4 text-green-500" /> Home Page
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Check className="w-4 h-4 text-green-500" /> Products
                        Listing
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Check className="w-4 h-4 text-green-500" /> Search &
                        Filters
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Check className="w-4 h-4 text-green-500" /> Shopping
                        Cart
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="relative pl-8 border-l-4 border-yellow-500">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-yellow-500" /> Product
                        Detail Page
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-yellow-500" /> Checkout
                        Process
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-yellow-500" /> User
                        Authentication
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-yellow-500" /> Order
                        Confirmation
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="relative pl-8 border-l-4 border-blue-500">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-blue-500" /> User
                        Dashboard
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-blue-500" /> Order
                        History
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-blue-500" /> Wishlist
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-blue-500" /> Address
                        Management
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="relative pl-8 border-l-4 border-purple-500">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-purple-500" /> Reviews &
                        Ratings
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-purple-500" /> Product
                        Compare
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-purple-500" /> Blog
                        Section
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <Circle className="w-4 h-4 text-purple-500" /> Order
                        Tracking
                      </li>
                    </ul>
                  </div>
                ...
                <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6 border-2 border-blue-200">
                  ...
                  <ol className="space-y-2 text-sm text-gray-700">
                    <li>
                      1️⃣ Create Product Detail Page with image gallery and
                      reviews
                    </li>
